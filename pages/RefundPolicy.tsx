    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 md:p-8">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-6 md:p-10">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed">
          ...
          <p>
            The Agri Record Management System provides a digital service (Farmer ID Card Generation). Upon successful payment of ₹15, the digital card is immediately generated and made available for download and printing.
          </p>
