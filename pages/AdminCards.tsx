      ...
      <header className="no-print sticky top-0 z-50 bg-purple-800 text-white shadow-xl border-b border-purple-900">
        <div className="max-w-7xl mx-auto px-4 h-14 md:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            <Link to="/admin/wallet" className="text-sm font-medium bg-emerald-700 hover:bg-emerald-600 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1.5 md:px-4 md:py-2">
              <span className="hidden sm:inline">Wallet Recharges</span>
